...
| 方案对客 | 范围、假设、风险和数据边界明确 | SL | 仅非标准且可控的交付承诺，或合同明确定义的费用调整/补救触发条件可升级 GM；平台分发、爆款/病毒传播、销量或 ROI 等不可控结果保证禁止提交审批，任何人不得批准 |
...
审批可以授权可测量、由图灵可控制的交付承诺（如约定数量、格式、审核节点、报告或响应时限），也可以授权合同明确定义的费用调整或补救触发条件；任何级别的审批都不得授权“保证平台分发、保证爆款/病毒传播、保证销量或保证 ROI”。平台表现和消费者行为只能作为带口径、条件和观察窗口的预测或目标。
...
批次应收总额是否含税，以及服务费、物流、授权和可选项是否计入，必须在发布单逐项写明。效果是否达到预测不影响已完成交付的付款义务。合同可按第 5.7 节审批，约定可测量且由图灵可控制的交付、费用调整或补救触发条件；但不得把平台分发、爆款/病毒传播、销量或 ROI 写成保证，合同中的预测目标也不自动转为付款豁免。
...
| 步骤 | 责任 | 标准输出 |
|---|---|---|
| 商务一轮初筛 | Sales | 按项目需要形成候选资源池；逐项评分并附来源/抓取日期，说明推荐逻辑、达人证据置信度 H/M/L 和重大风险，状态标记“待 Ops 专业复核” |
| 运营专业核验 | Ops | 最终核验身份与真实性、目标受众、内容质量、历史表现、异常数据、品牌安全、报价、档期、授权/权利、交付与合作风险；形成可追溯核验结论 |
| 内部推荐与最终批准 | Ops 主责，Strategy、Sales 协作 | 仅 Ops 最终专业批准后的名单可进入对客版本；保留剔除、补件、替换及审批记录 |
| 客户短名单 | Sales、客户 | 客户书面确认 5 至 10 名优先候选，数量可按项目调整 |
| 最终确认 | Ops、客户 | 达人确认意愿、价格、档期、内容和合作文件 |

达人名单至少包含：主页链接、平台、地区、受众、近 30 至 90 天数据、内容质量、历史合作、推荐理由、达人证据置信度 H/M/L、风险、品牌安全、价格、授权/权利、档期、交付可行性、数据来源、抓取日期，以及“待 Ops 专业复核 / Ops 已批准 / Ops 退回补件”的明确状态。
...
项目发布前必须完成《项目测量口径表》，至少锁定：平台和数据源、曝光或播放分母、点击追踪方式、转化事件、归因窗口及模型、达人或媒体成本、客户总投入成本、归因销售收入采用毛额还是净额、折扣/取消/退款处理、税费、物流、产品成本、币种与汇率、数据冻结时间。未完成口径表时，只报告平台原始数据，不输出 ROAS、客户营销 ROI 或 CPA 的对比结论。
...
| 毛额 ROAS（Gross ROAS） | 约定归因的毛额销售收入 ÷ 投放成本 | 必须标“毛额”；说明折扣是否已冲减，取消/退款尚未冲回，不得与净额 ROAS 合并为无标签的“ROAS” |
| 净额 ROAS（Net ROAS） | 约定归因的净额销售收入 ÷ 投放成本 | 必须标“净额”；按测量口径冲减折扣、取消与退款并写明数据冻结时间 |
| 客户营销 ROI | （约定归因的客户侧增量贡献毛利 - 客户营销总投入）÷ 客户营销总投入 × 100% | 客户侧贡献毛利和投入范围必须在项目开始前约定；不得用第5.5节图灵项目贡献毛利替代 |

所有比率和单位成本统一执行零值规则：分母为 0 或未知时标记“不可计算”，不得输出无穷大或臆造数值；相关公式的分子为 0 且分母为已知正数时，结果为 0。同一项目只能选择一种点击率作为主 KPI，跨达人或跨平台报告不得混用不同分母。所有数据必须记录平台、数据源、统计窗口、归因方式、币种、成本范围和提取日期。无法追踪转化时，只汇报可验证的曝光、互动和点击，不推定销售结果。
...
项目目标、KPI、预算和排期：
已确认达人、平台、内容和授权：
达人名单 Ops 最终专业复核状态（待复核 / 已批准 / 退回补件；复核人、日期、记录链接）：
客户决策人、执行人和审批人：
客户承诺提供的资料和日期：
图灵已承诺的范围、修改和例外：
风险、未决问题及升级路径：
...
|---|---|---|---|
| 第1周 | 营销基础：[《01-商务新人海外红人营销基础培训手册-v1.0》](商务培训/01-商务新人海外红人营销基础培训手册-v1.0.md) | 完成仅覆盖《01》当周已教内容的形成性基础校准和错误纠偏；不计正式认证成绩 | 仅可在主管复核下学习和旁听，不得独立作对客效果、平台能力、权利或合规承诺；正式综合理论认证在完成《01》—《04》教学后的第3周末实施 |
...
| 第3周 | 产品与达人：[《03-产品平台达人内容匹配案例库-v1.0》](商务培训/03-产品平台达人内容匹配案例库-v1.0.md)、[《04-达人质量评估评分卡-v1.0》](商务培训/04-达人质量评估评分卡-v1.0.md) | 完成《01》—《04》教学后，正式综合理论 ≥85 且11个红线域100%正确；唯一正式五账号达人实操按[《06》§3.1.1](商务培训/06-五周培养与上岗认证-v1.0.md#311-达人实操的锁定计分完整度与答案密钥)计分并达到 ≥85，每张卡及五卡整体完整度均 ≥90%，重大红旗零漏判；理论与实操分别计分 | 正式理论未通过不得进入真实对客触达；不得以初筛替代运营终审，不得独立锁定达人、确认价格/档期、安排寄样、签达人合作或承诺交付 |
...
独立上岗前还须完成：2 场跟会旁听（shadowed meetings）、2 场由学员主导且主管出席的客户会议、1 次报价/交接演练，并由直属主管或考官留存结果。两类“2 场”会议均须各自至少有 1 场真实客户会议；仅在客户保密、取消或业务量不足时，每类最多可由销售负责人书面批准 1 场高保真脱敏模拟替代，并留存理由、脚本、录音/录像索引、统一评分表和复盘。任一类别真实会议为 0 时均保持受监督状态；多场模拟不得累加为独立上岗条件。任一适用门槛未通过，不得独立报价、对客承诺或推进 L0—L9 的关键门禁。
...
| v2.1 | 2026-09-09 | 受控试运行版 | 明确Sales证据化一轮初筛与Ops最终专业批准，统一ROAS毛额/净额及客户营销ROI口径，并锁定可控交付承诺边界 |
| v2.1 | 2026-09-13 | 受控试运行版 | 锁定五账号达人实操100分计分、每卡/整体完整度及Ops答案密钥引用；不改变业务权限与运营终审边界 |
...
- [ ] 商务独立上岗人员达到：理论考试不低于 85 分、红线题 100% 正确、平台与产品案例不低于 80 分、达人评估实操按《06》§3.1.1达到不低于 85 分且每卡/整体完整度均不低于90%、重大红旗零漏判、Roleplay 不低于 80 分，且完整项目答辩无重大流程、合规或承诺漏判
