...
test('migration verifier accepts a populated sanitized version 1 source and reaches version 21', (t) => {
...
test('migration verifier accepts a populated managed version 9 source and upgrades it to version 21', (t) => {
...
test('migration verifier upgrades an existing managed version 10 source to version 21', (t) => {
...
test('migration verifier upgrades an existing managed version 11 source to version 21', (t) => {
...
test('migration verifier upgrades the production predecessor version 20 to version 21', (t) => {
...
test('migration verifier upgrades the current production predecessor version 23 to version 24', (t) => {
  const fixture = createFixture(t, 'v23-to-v24', 23);
  const sourceSha256 = sha256File(fixture.databasePath);
