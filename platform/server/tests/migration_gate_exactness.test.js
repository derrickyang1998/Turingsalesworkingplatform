...
test('migration verifier accepts a populated sanitized version 1 source and reaches version 15', (t) => {
  const fixture = createFixture(t, 'v1-to-v15', 1);
...
test('migration verifier accepts a populated managed version 9 source and upgrades it to version 15', (t) => {
  const fixture = createFixture(t, 'v9-to-v15', 9);
  const sourceSha256 = sha256File(fixture.databasePath);
...
test('migration verifier upgrades an existing managed version 10 source to version 15', (t) => {
  const fixture = createFixture(t, 'v10-to-v15', 10);
  const sourceSha256 = sha256File(fixture.databasePath);
...
test('migration verifier upgrades an existing managed version 11 source to version 15', (t) => {
  const fixture = createFixture(t, 'v11-to-v15', 11);
  const sourceSha256 = sha256File(fixture.databasePath);
