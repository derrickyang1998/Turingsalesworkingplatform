...
const V12_EQUALITY_GROUPS = Object.freeze([
  ...EQUALITY_GROUPS,
  Object.freeze({
    name: 'performance-ai-review-audit-fingerprint',
    owner: 'request_idempotency.audit_fingerprint',
    members: Object.freeze([
      'request_idempotency.audit_fingerprint',
      'performance_ai_review_audits.audit_fingerprint'
    ]),
    mode: 'owner-snapshot-value-partition'
  })
]);
const V14_EQUALITY_GROUPS = Object.freeze([
  ...V12_EQUALITY_GROUPS,
  Object.freeze({
    name: 'customer-report-ppt-snapshot-hash',
    owner: 'customer_report_snapshots.report_sha256',
    members: Object.freeze([
      'customer_report_snapshots.report_sha256',
      'customer_report_ppt_artifacts.snapshot_report_sha256'
    ]),
    mode: 'owner-snapshot-value-partition'
  })
]);
...
const V10_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V9_MIGRATION_LEDGER.name,
    '010_performance_manual_foundation'
  ]),
  checksum: Object.freeze([
    ...V9_MIGRATION_LEDGER.checksum,
    'a2151468d862006441413360ca418629177e7842c93caabf23c1a64fbf8c8ec8'
  ]),
  sourcePath: Object.freeze([
    ...V9_MIGRATION_LEDGER.sourcePath,
...
const V12_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V11_MIGRATION_LEDGER.name,
    '012_performance_ai_review_audit'
  ]),
  checksum: Object.freeze([
    ...V11_MIGRATION_LEDGER.checksum,
    '43776bc1faf9abe3052b1e767ecbcc33526e2325d26ba975e2752a7764f8f2e3'
  ]),
  sourcePath: Object.freeze([
    ...V11_MIGRATION_LEDGER.sourcePath,
    'migrations/012_performance_ai_review_audit.js'
  ])
});
const V13_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V12_MIGRATION_LEDGER.name,
    '013_customer_report_snapshot'
  ]),
  checksum: Object.freeze([
    ...V12_MIGRATION_LEDGER.checksum,
    '7f4e24df8af4f5d73a2e957f64cd2803cdcf67c52cc59f20dcb51ede5e4415c4'
  ]),
  sourcePath: Object.freeze([
    ...V12_MIGRATION_LEDGER.sourcePath,
    'migrations/013_customer_report_snapshot.js'
  ])
});
const V14_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V13_MIGRATION_LEDGER.name,
    '014_customer_report_ppt_artifact'
  ]),
  checksum: Object.freeze([
    ...V13_MIGRATION_LEDGER.checksum,
    '46fb53f45cc854fae0a0c30999d6600840efbd14d130ba6ec7e9e8cac84ef3c8'
  ]),
  sourcePath: Object.freeze([
    ...V13_MIGRATION_LEDGER.sourcePath,
    'migrations/014_customer_report_ppt_artifact.js'
  ])
});
const V15_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V14_MIGRATION_LEDGER.name,
    '015_influencer_saved_views'
  ]),
  checksum: Object.freeze([
    ...V14_MIGRATION_LEDGER.checksum,
    'd7a2763d91d4009123d1f852d1ac1365d6ffce648fb308496ab1bbc3663e0f01'
  ]),
  sourcePath: Object.freeze([
    ...V14_MIGRATION_LEDGER.sourcePath,
...
const V17_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V16_MIGRATION_LEDGER.name,
    '017_collaboration_publication_custody'
  ]),
  checksum: Object.freeze([
    ...V16_MIGRATION_LEDGER.checksum,
    '5a8475d7beb3599970b4dcdb36455f65e54eb375f9273ae54be45f6c872a02b3'
  ]),
  sourcePath: Object.freeze([
    ...V16_MIGRATION_LEDGER.sourcePath,
...
const V20_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V19_MIGRATION_LEDGER.name,
    '020_organization_methodology_promotion'
  ]),
  checksum: Object.freeze([
    ...V19_MIGRATION_LEDGER.checksum,
    '7a9ace99630086fbb5b1554d995c4fe251e1611f77710a08c20a7cb37818b914'
  ]),
  sourcePath: Object.freeze([
    ...V19_MIGRATION_LEDGER.sourcePath,
    'migrations/020_organization_methodology_promotion.js'
  ])
});
const V21_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V20_MIGRATION_LEDGER.name,
    '021_organization_role_governance'
  ]),
  checksum: Object.freeze([
    ...V20_MIGRATION_LEDGER.checksum,
    'a3fd40332b2e1fab99a6fc2b3eba2391318d56758059d6554bdef8a7db5dc274'
  ]),
  sourcePath: Object.freeze([
    ...V20_MIGRATION_LEDGER.sourcePath,
    'migrations/021_organization_role_governance.js'
  ])
});
const V22_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V21_MIGRATION_LEDGER.name,
    '022_organization_ownership_transfer'
  ]),
  checksum: Object.freeze([
  ...
  sourcePath: Object.freeze([
    ...
    'migrations/022_organization_ownership_transfer.js'
  ])
});
const V23_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V22_MIGRATION_LEDGER.name,
    '023_influencer_tenant_ownership'
  ]),
  checksum: Object.freeze([
    ...V22_MIGRATION_LEDGER.checksum,
    '6af60de79947017047b3fe5a2f34d209a9d44690bf3adb7ad90d72fb02b9518d'
  ]),
  sourcePath: Object.freeze([
    ...V22_MIGRATION_LEDGER.sourcePath,
...
const V25_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V24_MIGRATION_LEDGER.name,
    '025_ai_conversation_tenant_ownership'
  ]),
  checksum: Object.freeze([
    ...V24_MIGRATION_LEDGER.checksum,
    '6bfc45d564132ec926757be738e596cf03ff56c7474ca9c98fbd12f5998ed171'
  ]),
  sourcePath: Object.freeze([
    ...V24_MIGRATION_LEDGER.sourcePath,
    'migrations/025_ai_conversation_tenant_ownership.js'
  ])
});
const V26_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V25_MIGRATION_LEDGER.name,
    '026_token_usage_tenant_ownership'
  ]),
  checksum: Object.freeze([
    ...V25_MIGRATION_LEDGER.checksum,
    '1c7e70f5c2a2b432215407ceb1f6178943b0e847f308b65b4157659c47897bfb'
  ]),
  sourcePath: Object.freeze([
    ...V25_MIGRATION_LEDGER.sourcePath,
    'migrations/026_token_usage_tenant_ownership.js'
  ])
});
const V27_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V26_MIGRATION_LEDGER.name,
    '027_plan_catalog_module_entitlements'
  ]),
  checksum: Object.freeze([
    ...V26_MIGRATION_LEDGER.checksum,
    '05503ef3abb2ba7fe875894acaa05a5e747f2eb2caaab82beab130ecfd451d53'
  ]),
  sourcePath: Object.freeze([
    ...V26_MIGRATION_LEDGER.sourcePath,
...
const V29_MIGRATION_LEDGER = Object.freeze({
  name: Object.freeze([
    ...V28_MIGRATION_LEDGER.name,
    '029_organization_monthly_ai_quota'
  ]),
  checksum: Object.freeze([
    ...V28_MIGRATION_LEDGER.checksum,
    '7dc622b7747f85710cad77bb0add45ceeeb6bc12e1327c3a8266a9c108e3e08c'
  ]),
  sourcePath: Object.freeze([
    ...V28_MIGRATION_LEDGER.sourcePath,
...
const STRUCTURAL_POLICY_V9_SHA256 = crypto.createHash('sha256')
  ...
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V10 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V9, {
  'campaign_publications.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'campaign_publications.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'campaign_publications.campaign_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'campaign_publications.created_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'campaign_publications.published_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'campaign_publications.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'campaign_publications.platform': Object.freeze({
    storage: 'text', kind: 'enum',
    allowedValues: Object.freeze(['tiktok', 'instagram', 'youtube', 'facebook', 'x', 'manual', 'custom'])
  }),
  'campaign_publications.source_mode': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['manual', 'csv_xlsx'])
  }),
  'performance_metric_observations.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_metric_observations.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_metric_observations.campaign_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_metric_observations.publication_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_metric_observations.created_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_metric_observations.observed_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'performance_metric_observations.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'performance_metric_observations.source_mode': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['manual', 'csv_xlsx'])
  }),
  'performance_manual_inputs.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_manual_inputs.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_manual_inputs.campaign_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_manual_inputs.publication_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_manual_inputs.supersedes_input_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_manual_inputs.created_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_manual_inputs.approved_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_manual_inputs.approved_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'performance_manual_inputs.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'performance_manual_inputs.approval_state': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['draft', 'approved'])
  }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V10_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V10_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V10_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V10_VALIDATOR_VERSION = 'tm-structural-policy-v5-performance-manual';
const STRUCTURAL_POLICY_V10_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V10_VALIDATOR_VERSION,
...
const STRUCTURAL_POLICY_V11_SHA256 = crypto.createHash('sha256')
  ...
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V12 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V11, {
  'performance_ai_review_audits.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_ai_review_audits.request_idempotency_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_ai_review_audits.token_usage_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_ai_review_audits.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_ai_review_audits.campaign_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_ai_review_audits.actor_user_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'performance_ai_review_audits.outcome': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['withheld', 'stale_snapshot'])
  }),
  'performance_ai_review_audits.reason_code': Object.freeze({
    storage: 'text',
    kind: 'enum',
  ...
  'performance_ai_review_audits.stage': Object.freeze({
    storage: 'text',
    kind: 'enum',
    allowedValues: Object.freeze([
  ...
  'performance_ai_review_audits.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V12_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V12_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V12_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V12_VALIDATOR_VERSION = 'tm-structural-policy-v7-performance-ai-review-audit';
const STRUCTURAL_POLICY_V12_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V12_VALIDATOR_VERSION,
    columns: STRUCTURAL_COLUMN_POLICY_V12
  }), 'utf8')
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V13 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V12, {
  'customer_report_snapshots.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_snapshots.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_snapshots.campaign_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_snapshots.created_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_snapshots.source_knowledge_entry_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_snapshots.report_contract_version': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['customer_safe_v1'])
  }),
  'customer_report_snapshots.redaction_policy_version': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['customer-safe-v1'])
  }),
  'customer_report_snapshots.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V13_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V13_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V13_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V13_VALIDATOR_VERSION = 'tm-structural-policy-v8-customer-report-snapshot';
const STRUCTURAL_POLICY_V13_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V13_VALIDATOR_VERSION,
    columns: STRUCTURAL_COLUMN_POLICY_V13
  }), 'utf8')
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V14 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V13, {
  'customer_report_ppt_artifacts.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_ppt_artifacts.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_ppt_artifacts.campaign_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_ppt_artifacts.snapshot_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_ppt_artifacts.created_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_ppt_artifacts.report_contract_version': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['customer_safe_v1'])
  }),
  'customer_report_ppt_artifacts.redaction_policy_version': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['customer-safe-v1'])
  }),
  'customer_report_ppt_artifacts.ppt_contract_version': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['customer-report-ppt-v1'])
  }),
  'customer_report_ppt_artifacts.artifact_bytes': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'customer_report_ppt_artifacts.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V14_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V14_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V14_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V14_VALIDATOR_VERSION = 'tm-structural-policy-v9-customer-report-ppt-artifact';
const STRUCTURAL_POLICY_V14_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V14_VALIDATOR_VERSION,
    columns: STRUCTURAL_COLUMN_POLICY_V14
  }), 'utf8')
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V15 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V14, {
  ...
  'influencer_saved_views.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'influencer_saved_views.updated_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V15_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V15_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
...
const STRUCTURAL_POLICY_V16_SHA256 = crypto.createHash('sha256')
  ...
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V17 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V16, {
  'collaboration_publication_custody.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'collaboration_publication_custody.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'collaboration_publication_custody.campaign_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'collaboration_publication_custody.collaboration_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'collaboration_publication_custody.publication_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'collaboration_publication_custody.review_submission_entry_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'collaboration_publication_custody.review_decision_entry_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'collaboration_publication_custody.publication_relation_link_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'collaboration_publication_custody.knowledge_entry_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'collaboration_publication_custody.confirmed_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'collaboration_publication_custody.registration_mode': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['created', 'existing'])
  }),
  'collaboration_publication_custody.confirmed_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'collaboration_publication_custody.published_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'collaboration_publication_custody.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V17_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V17_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V17_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V17_VALIDATOR_VERSION = 'tm-structural-policy-v13-publication-custody';
const STRUCTURAL_POLICY_V17_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V17_VALIDATOR_VERSION,
...
const STRUCTURAL_POLICY_V19_SHA256 = crypto.createHash('sha256')
  ...
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V20 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V19, {
  'organization_knowledge_custody.knowledge_entry_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_knowledge_custody.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_knowledge_custody.custody_type': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['methodology'])
  }),
  'organization_knowledge_custody.created_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_knowledge_custody.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'organization_methodology_promotion_requests.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_requests.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_requests.source_campaign_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_requests.source_knowledge_entry_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_requests.requested_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_requests.first_approved_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_requests.expected_governance_version': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_requests.supersedes_knowledge_entry_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_requests.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'organization_methodology_promotion_decisions.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_decisions.request_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_decisions.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_decisions.decision': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['approved', 'rejected'])
  }),
  'organization_methodology_promotion_decisions.decided_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_decisions.target_knowledge_entry_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_decisions.supersedes_knowledge_entry_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_methodology_promotion_decisions.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V20_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V20_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V20_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V20_VALIDATOR_VERSION = 'tm-structural-policy-v17-organization-methodology';
const STRUCTURAL_POLICY_V20_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V20_VALIDATOR_VERSION,
    columns: STRUCTURAL_COLUMN_POLICY_V20
  }), 'utf8')
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V21 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V20, {
  'organization_member_policy.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_member_policy.user_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_member_policy.access_mode': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['read_write', 'read_only'])
  }),
  'organization_member_policy.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'organization_member_policy.updated_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'organization_authority.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_authority.owner_user_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_authority.created_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_authority.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V21_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V21_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V21_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V21_VALIDATOR_VERSION = 'tm-structural-policy-v18-organization-role-governance';
const STRUCTURAL_POLICY_V21_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V21_VALIDATOR_VERSION,
    columns: STRUCTURAL_COLUMN_POLICY_V21
  }), 'utf8')
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V22 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V21, {
  ...
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V22_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V22_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
...
const STRUCTURAL_POLICY_V22_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    ...
    columns: STRUCTURAL_COLUMN_POLICY_V22
  }), 'utf8')
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V23 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V22, {
  'influencers.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V23_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V23_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V23_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V23_VALIDATOR_VERSION = 'tm-structural-policy-v21-influencer-tenant-ownership';
const STRUCTURAL_POLICY_V23_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V23_VALIDATOR_VERSION,
...
const STRUCTURAL_POLICY_V24_SHA256 = crypto.createHash('sha256')
  ...
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V25 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V24, {
  'ai_conversations.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V25_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V25_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V25_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V25_VALIDATOR_VERSION = 'tm-structural-policy-v23-ai-conversation-tenant-ownership';
const STRUCTURAL_POLICY_V25_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V25_VALIDATOR_VERSION,
    columns: STRUCTURAL_COLUMN_POLICY_V25
  }), 'utf8')
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V26 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V25, {
  'token_usage.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V26_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V26_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V26_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V26_VALIDATOR_VERSION = 'tm-structural-policy-v24-token-usage-tenant-ownership';
const STRUCTURAL_POLICY_V26_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V26_VALIDATOR_VERSION,
    columns: STRUCTURAL_COLUMN_POLICY_V26
  }), 'utf8')
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V27 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V26, {
  'plan_catalog.code': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['crm_core', 'legacy_full'])
  }),
  'plan_catalog.name_zh': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['客户关系核心版', '完整兼容版'])
  }),
  'plan_catalog.name_en': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['CRM Core', 'Legacy Full'])
  }),
  'plan_catalog.catalog_version': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'plan_catalog.status': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['active'])
  }),
  'plan_catalog.display_order': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'plan_catalog.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'plan_module_entitlements.plan_code': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['crm_core', 'legacy_full'])
  }),
  'plan_module_entitlements.module_code': Object.freeze({
    storage: 'text',
    kind: 'enum',
    allowedValues: Object.freeze([
  ...
  'plan_module_entitlements.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'organization_plan_assignments.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_plan_assignments.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_plan_assignments.plan_code': Object.freeze({
    storage: 'text', kind: 'enum', allowedValues: Object.freeze(['crm_core', 'legacy_full'])
  }),
  'organization_plan_assignments.assignment_version': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_plan_assignments.assigned_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_plan_assignments.source': Object.freeze({
    storage: 'text',
    kind: 'enum',
    allowedValues: Object.freeze(['migration_backfill', 'organization_default', 'admin_assignment'])
  }),
  'organization_plan_assignments.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V27_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V27_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V27_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V27_VALIDATOR_VERSION = 'tm-structural-policy-v25-plan-catalog-module-entitlements';
const STRUCTURAL_POLICY_V27_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V27_VALIDATOR_VERSION,
...
const STRUCTURAL_POLICY_V28_SHA256 = crypto.createHash('sha256')
  ...
  .digest('hex');
const STRUCTURAL_COLUMN_POLICY_V29 = Object.freeze(Object.assign(Object.create(null), STRUCTURAL_COLUMN_POLICY_V28, {
  'organization_ai_quota_policies.id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_ai_quota_policies.org_id': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_ai_quota_policies.policy_version': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_ai_quota_policies.monthly_limit': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_ai_quota_policies.changed_by': Object.freeze({ storage: 'integer', kind: 'integer' }),
  'organization_ai_quota_policies.source': Object.freeze({
    storage: 'text',
    kind: 'enum',
    allowedValues: Object.freeze(['migration_backfill', 'organization_default', 'admin_update'])
  }),
  'organization_ai_quota_policies.created_at': Object.freeze({ storage: 'text', kind: 'timestamp' }),
  'schema_migrations.name': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V29_MIGRATION_LEDGER.name
  }),
  'schema_migrations.checksum': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V29_MIGRATION_LEDGER.checksum
  }),
  'schema_migrations.source_path': Object.freeze({
    storage: 'text', kind: 'migration-ledger', allowedValues: V29_MIGRATION_LEDGER.sourcePath
  })
}));
const STRUCTURAL_POLICY_V29_VALIDATOR_VERSION = 'tm-structural-policy-v27-organization-monthly-ai-quota';
const STRUCTURAL_POLICY_V29_SHA256 = crypto.createHash('sha256')
  .update(JSON.stringify({
    validatorVersion: STRUCTURAL_POLICY_V29_VALIDATOR_VERSION,
...
const V10_SEMANTIC_POLICIES = Object.freeze({
  ...SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V10_VALIDATOR_VERSION,
...
const V12_SEMANTIC_POLICIES = Object.freeze({
  ...SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V12_VALIDATOR_VERSION,
    policySha256: STRUCTURAL_POLICY_V12_SHA256
  })
});
const V13_SEMANTIC_POLICIES = Object.freeze({
  ...SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V13_VALIDATOR_VERSION,
    policySha256: STRUCTURAL_POLICY_V13_SHA256
  })
});
const V14_SEMANTIC_POLICIES = Object.freeze({
  ...SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V14_VALIDATOR_VERSION,
    policySha256: STRUCTURAL_POLICY_V14_SHA256
  })
});
const V15_SEMANTIC_POLICIES = Object.freeze({
  ...SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V15_VALIDATOR_VERSION,
...
const V17_SEMANTIC_POLICIES = Object.freeze({
  ...SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V17_VALIDATOR_VERSION,
...
const V20_SEMANTIC_POLICIES = Object.freeze({
  ...V19_SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...V19_SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V20_VALIDATOR_VERSION,
    policySha256: STRUCTURAL_POLICY_V20_SHA256
  })
});
const V21_SEMANTIC_POLICIES = Object.freeze({
  ...V20_SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...V20_SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V21_VALIDATOR_VERSION,
    policySha256: STRUCTURAL_POLICY_V21_SHA256
  })
});
const V22_SEMANTIC_POLICIES = Object.freeze({
  ...V21_SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...V21_SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V22_VALIDATOR_VERSION,
    policySha256: STRUCTURAL_POLICY_V22_SHA256
  })
});
const V23_SEMANTIC_POLICIES = Object.freeze({
  ...V22_SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...V22_SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V23_VALIDATOR_VERSION,
...
const V25_SEMANTIC_POLICIES = Object.freeze({
  ...V24_SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...V24_SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V25_VALIDATOR_VERSION,
    policySha256: STRUCTURAL_POLICY_V25_SHA256
  })
});
const V26_SEMANTIC_POLICIES = Object.freeze({
  ...V25_SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...V25_SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V26_VALIDATOR_VERSION,
    policySha256: STRUCTURAL_POLICY_V26_SHA256
  })
});
const V27_SEMANTIC_POLICIES = Object.freeze({
  ...V26_SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...V26_SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V27_VALIDATOR_VERSION,
...
const V29_SEMANTIC_POLICIES = Object.freeze({
  ...V28_SEMANTIC_POLICIES,
  structuralColumns: Object.freeze({
    ...V28_SEMANTIC_POLICIES.structuralColumns,
    validatorVersion: STRUCTURAL_POLICY_V29_VALIDATOR_VERSION,
...
function structuralColumnPolicyForVersion(schemaVersion) {
  ...
  if (schemaVersion === 20) return STRUCTURAL_COLUMN_POLICY_V20;
  ...
  if (schemaVersion === 12) return STRUCTURAL_COLUMN_POLICY_V12;
...
const DIGEST_NAMES = new Set([
  ...
  'template_checksum', 'bundle_id', 'artifact_cache_key', 'run_key', 'dedupe_sha256'
]);
...
function rebuiltKnowledgeSourceIdentity(row, custody) {
  ...
  if (
    row.business_type === 'organization' &&
    row.source_type === 'organization_performance_methodology'
  ) {
    return framedSha256([
...
function profileContractForVersion(schemaVersion) {
  ...
  if (schemaVersion === 10) {
    return Object.freeze({
      semanticPolicies: V10_SEMANTIC_POLICIES,
      equalityGroups: EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
  ...
  if (schemaVersion === 12) {
    return Object.freeze({
      semanticPolicies: V12_SEMANTIC_POLICIES,
      equalityGroups: V12_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
    });
  ...
  if (schemaVersion === 13) {
    return Object.freeze({
      semanticPolicies: V13_SEMANTIC_POLICIES,
      equalityGroups: V12_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
  ...
  if (schemaVersion === 14) {
    return Object.freeze({
      semanticPolicies: V14_SEMANTIC_POLICIES,
  ...
  if (schemaVersion === 15) {
    return Object.freeze({
      semanticPolicies: V15_SEMANTIC_POLICIES,
      equalityGroups: V14_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
  ...
  if (schemaVersion === 17) {
    return Object.freeze({
      semanticPolicies: V17_SEMANTIC_POLICIES,
      equalityGroups: V14_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: V17_DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
    });
  }
  if (schemaVersion === 18) {
  ...
  if (schemaVersion === 20) {
    return Object.freeze({
      semanticPolicies: V20_SEMANTIC_POLICIES,
      equalityGroups: V19_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
  ...
  if (schemaVersion === 21) {
    return Object.freeze({
      semanticPolicies: V21_SEMANTIC_POLICIES,
      equalityGroups: V19_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: V20_DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
  ...
  if (schemaVersion === 22) {
    return Object.freeze({
      semanticPolicies: V22_SEMANTIC_POLICIES,
      equalityGroups: V19_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: V20_DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
  ...
  if (schemaVersion === 23) {
    return Object.freeze({
      semanticPolicies: V23_SEMANTIC_POLICIES,
      equalityGroups: V19_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: V20_DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
  ...
  if (schemaVersion === 25) {
    return Object.freeze({
      semanticPolicies: V25_SEMANTIC_POLICIES,
      equalityGroups: V19_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: V20_DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
  ...
  if (schemaVersion === 26) {
    return Object.freeze({
      semanticPolicies: V26_SEMANTIC_POLICIES,
      equalityGroups: V19_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: V20_DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
  ...
  if (schemaVersion === 27) {
    return Object.freeze({
      semanticPolicies: V27_SEMANTIC_POLICIES,
      equalityGroups: V19_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: V20_DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
  ...
  if (schemaVersion === 29) {
    return Object.freeze({
      semanticPolicies: V29_SEMANTIC_POLICIES,
      equalityGroups: V19_EQUALITY_GROUPS,
      referenceGroups: REFERENCE_GROUPS,
      derivedRebuilds: V20_DERIVED_REBUILDS,
      preservedAccounting: PRESERVED_ACCOUNTING
...
function jsonColumnPolicy(table, column) {
  if (table === 'organization_methodology_promotion_requests' && column === 'dimensions_json') {
    return {
      mode: 'closed',
      allowedPaths: [
        '/', '/schema_version', '/product', '/category', '/platform',
        '/audience', '/hypothesis', '/method'
      ],
...
function structuralJsonLeaf(context, pointer) {
  if (context === 'organization_methodology_promotion_requests.dimensions_json') {
    return pointer === '/schema_version';
  }
...
function rebuildOrganizationMethodologyDigests(db) {
  const present = db.prepare(`
    SELECT 1 AS present
    FROM sqlite_schema
    WHERE type='table' AND name='organization_methodology_promotion_requests'
  `).get();
  if (!present) return;
  const update = db.prepare(`
    UPDATE organization_methodology_promotion_requests
    SET dedupe_sha256=?
    WHERE id=?
  `);
  for (const row of db.prepare(`
    SELECT id,org_id,dimensions_json
    FROM organization_methodology_promotion_requests
    ORDER BY id
  `).all()) {
    update.run(
      sha256(`tm-organization-methodology-dedupe-v2\n${row.org_id}\n${row.dimensions_json}`),
      row.id
    );
  }
}
