...
process.stdin.on("end", () => {
  const health = JSON.parse(body);
  const expected = "57b88420afa9d7d6b9bfec6dcd7c4e5fce74c76762b00bb810d9c44a4ee354d4";
