...
process.stdin.on("end", () => {
  const health = JSON.parse(body);
  const expected = "7c12f7f325a0c9be8af37ce3d6eff6a5b47f37dac2264fc9ee67d7be1594e7d7";
