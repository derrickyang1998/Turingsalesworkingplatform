...
process.stdin.on("end", () => {
  const health = JSON.parse(body);
  const expected = "2bb63e7919ea036a17396773da7ad524ea22bd46ac202f4dc454747a5b3f1771";
