(function () {
  ...
  var NAV_PAGES = [
    ...
    { id: 'performance-monitor', icon: '监', label: '内容监控' },
    { id: 'performance-dashboard', icon: '效', label: '效果看板' },
  ...
  var ADMIN_TABS = ['overview', 'users', 'organizations', 'knowledge', 'ai-audit', 'tokens', 'operations'];
  var activeUser = null;
