...
- [x] **EN:** Apply ownership/team/admin knowledge visibility before retrieval and preserve administrator-wide conversation audit with audit logging. Production accepted through Task 4C on 2026-08-26.<br>**中文：** 检索前执行所有者/团队/管理员知识可见性规则，并保留管理员全量对话审计及审计日志；已于 2026-08-26 通过 Task 4C 生产验收。
