...
- **EN:** Current accepted production release is `v0.9.11-protected-account-reset`, source `70a03844ad1d7cee9bd821d368521cb1d9ec1413`, deployed and verified on 2026-09-18. Ordinary work follows one independently useful feature per immediate production release; broad regression remains phase-closeout or risk-triggered.<br>**中文：** 当前已验收生产版本为 `v0.9.11-protected-account-reset`，源码 `70a03844ad1d7cee9bd821d368521cb1d9ec1413`，已于 2026-09-18 部署并验收。普通工作继续按一个独立可用功能一个即时生产版本推进，完整回归仅由阶段收口或风险触发。
